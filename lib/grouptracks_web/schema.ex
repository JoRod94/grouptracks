defmodule GrouptracksWeb.Schema do
  use Absinthe.Schema
  import_types GrouptracksWeb.Schema.Types
  alias GrouptracksWeb.AccountsResolver
  alias GrouptracksWeb.SharingResolver
  alias GrouptracksWeb.MusicResolver
  ...
  mutation do
    ...
    field :generate_playlist, :playlist do
      ...
      arg :nr_top_artists, non_null(:integer)
