defmodule Grouptracks.Music do
  @moduledoc """
  The Music context.
  """
  ...
  alias Grouptracks.Music.Playlist
  ...
  def create_playlist(attrs \\ %{}) do
    if Map.has_key?(attrs, :group_id) && attrs.group_id != nil, do: Grouptracks.Sharing.get_group!(attrs.group_id)
    %Playlist{}
