defmodule Grouptracks.Accounts.User do
  ...
  schema "users" do
    ...
    many_to_many :groups, Grouptracks.Sharing.Group, join_through: Grouptracks.Sharing.GroupUser, on_delete: :delete_all, on_replace: :delete
  ...
  defp validate_user_id(changeset, attrs) do
    if Application.get_env(:grouptracks, :current_env) != :test do
