defmodule Grouptracks.Sharing.Group do
  use Ecto.Schema
  ...
  schema "groups" do
    field :name, :string
    has_many :playlists, Grouptracks.Music.Playlist, on_delete: :delete_all, on_replace: :delete
    many_to_many :users, Grouptracks.Accounts.User, join_through: Grouptracks.Sharing.GroupUser, on_delete: :delete_all, on_replace: :delete
